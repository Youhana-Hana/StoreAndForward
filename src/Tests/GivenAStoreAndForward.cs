namespace Tests
{
    ...
    public class GivenAStoreAndForward
    {
        ...
        [TestMethod]
        public void WhenCallingStoreShouldForwardMessages()
        {
            ...
            var message2 = new Message("application/json", "Body", new Uri("http://www.google.com/1/api"), null);
            
            this.StoreAndForward = new StoreAndForward();
            this.StoreAndForward.Start();
            this.StoreAndForward.Store(message);
            this.StoreAndForward.Store(message);
            this.StoreAndForward.Store(message2);
            this.StoreAndForward.Store(message2);
